...
<div id="erdfg<?php	echo $row['id']; ?>">					  <?php $conditions = $row['conditions'];$result2= mysqli_query($con, "SELECT * FROM `commands` WHERE id ='$conditions'"); $row2=mysqli_fetch_array($result2); $reschecked = $row2['laststate'];if($reschecked){echo "<img src='css/on.png'>";} else {echo "<img src='css/off.png'>";}	?>
           </div>
