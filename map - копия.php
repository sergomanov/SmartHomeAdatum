...
<div class="page-sidebar mini mini-mobile" id="main-menu" data-inner-menu="1">
  ...
  <li    <?php if($imyaStranici=='map.php'){echo "class='active'";}?>><a href="map.php?map=77"><i class="icon-windows"></i> Зал </a></li>
...
<div class="draggable tip" id="dragl<?php echo $row6['address']; ?><?php echo $mode8.$maps; ?>" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="<?php echo $name6." - ".$address6; ?>" style="  position: absolute;  top: 200px;  left: 500px; color: <?php echo $color8; ?>;">
<i class="<?php echo $ico8; ?>" style="font-size: 20px;"></i><div style="margin:-3px;"><?php echo $vale7; ?> <?php echo $symbol8; ?></div>
 <?php   if(isset($_GET['edit'])){  ?>
 <input TYPE=text value=''   size='25' name="name" id='top<?php echo $row6['address']; ?><?php echo $mode8.$maps; ?>' style="background-color: transparent;font-size: 8px;min-height: 16px;"/><br>
 <input TYPE=text value=''  size='25' name="name" id='left<?php echo $row6['address']; ?><?php echo $mode8.$maps; ?>' style="background-color: transparent;font-size: 8px;min-height: 16px;"/>
 <?php  }  ?>
 </div>
...
<script>
  $(function() {
    ...
    scroll: false,
      ...
      document.getElementById('top<?php echo $row6['address']; ?><?php echo $mode8.$maps; ?>').value =  'pol=top<?php echo $row6['address']; ?><?php echo $mode8.$maps; ?>&cor=' + ui.position.top  ;
     document.getElementById('left<?php echo $row6['address']; ?><?php echo $mode8.$maps; ?>').value =  'pol=left<?php echo $row6['address']; ?><?php echo $mode8.$maps; ?>&cor=' + ui.position.left  ;
    }
...
// echo $reschecked;
 ...
 <img src="<?php echo $img99; ?>" width="55" alt="lorem"><div style="margin:-3px;">5ч 20мин</div>
 <?php   if(isset($_GET['edit'])){  ?> 
 <input TYPE=text value=''  size='20' name="name" id='top<?php echo $row9['id'].$address2; ?>' style="background-color: transparent;font-size: 8px;min-height: 16px;"/><br>
 <input TYPE=text value=''  size='20' name="name" id='left<?php echo $row9['id'].$address2; ?>' style="background-color: transparent ;font-size: 8px; min-height: 16px; "/>
<?php  }  ?>
 </div>
   <?php   if(isset($_GET['edit'])){  ?>
...
<script>
  $(function() {
    ...
    scroll: false,
         drag: function(event, ui) {
      document.getElementById('top<?php echo $row9['id'].$address2; ?>').value =  'pol=top<?php echo $row9['id'].$address2; ?>&cor=' + ui.position.top  ;
     document.getElementById('left<?php echo $row9['id'].$address2; ?>').value =  'pol=left<?php echo $row9['id'].$address2; ?>&cor=' + ui.position.left  ;
    }
...
{
  ?>
  <a href="map.php?map=<?php echo $maps;?>" style="  position: absolute;  top: 85px;  left: 30px;"><i class="icon-windows"></i> Закончить редактирование </a>	

 <?php 
} else {
  ?>	
<a href="map.php?map=<?php echo $maps;?>&edit=1" style="  position: absolute;  top: 85px;  left: 30px;"><i class="icon-windows"></i> Редактировать </a>
	 <?php 
} 
  ?>
...
<input type="submit" name="formSubmit" value="Submit"  style="  position: absolute;  top: 105px;  left: 30px;"/>
